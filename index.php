...
function check_ban($gmail){
    ...
    $header[] = "content-type: application/x-www-form-urlencoded;charset=UTF-8"; 
    $c = curl_init("https://accounts.google.com/_/signup/accountdetails?hl=ar&_reqid=248750&rt=j"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
...
function checkGmail($mail){
  ...
  $mail = preg_replace('/@(.*)/', '',$mail);
   $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,'https://accounts.google.com/_/signup/accountdetails?hl=ar&_reqid=248750&rt=j');
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
